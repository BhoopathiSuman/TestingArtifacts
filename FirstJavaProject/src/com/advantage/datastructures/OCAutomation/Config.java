...
public class Config {
	...
	private String sASMUserName;
	private String sASMPassword;
	private String sPAUserName;	
	private String sPAPassword;
	private String sLOAUserName;	
	private String sLOAPassword;
	...
	/**
	 * @return the sASMUserName
	 */
	public String getASMsUserName()
	{
		return sASMUserName;
	}
	
	/**
	 * @return the sASMPassword
	 */
	public String getsASMPassword()
	{
		return sASMPassword;
	}
	
	/**
	 * @return the sPAUserName
	 */
	public String getPAsUserName()
	{
		return sPAUserName;
	}
	
	/**
	 * @return the sPAPassword
	 */
	...
	/**
	 * @return the sLOAUserName
	 */
	public String getLOAsUserName()
	{
		return sLOAUserName;
	}
	
	/**
	 * @return the sLOAPassword
	 */
	public String getsLOAPassword()
	{
		return sLOAPassword;
	}	
	...
	public void initialize()
	{
		...
		try
		{
			 ...
			 */
			sASMUserName = xml.getNodeValue(sXpathRoot + "/AppConfig/ENV/ASMUserName", "");
			sASMPassword = xml.getNodeValue(sXpathRoot + "/AppConfig/ENV/ASMPassword", "");
			sPAUserName = xml.getNodeValue(sXpathRoot + "/AppConfig/ENV/PAUserName", "");
			sPAPassword = xml.getNodeValue(sXpathRoot + "/AppConfig/ENV/PAPassword", "");
			sLOAUserName = xml.getNodeValue(sXpathRoot + "/AppConfig/ENV/LOAUserName", "");
			sLOAPassword = xml.getNodeValue(sXpathRoot + "/AppConfig/ENV/LOAPassword", "");
	...
	public String toString() {
		return "Config [sConfigFilePath=" + sConfigFilePath + ", sBrowserType="
				...
				+ mapCustomConfig + ", sASMUserName=" + sASMUserName
				+ ", sASMPassword=" + sASMPassword + ", sPAUserName="
				+ sPAUserName + ", sPAPassword=" + sPAPassword
				+ ", sLOAUserName=" + sLOAUserName + ", sLOAPassword="
				+ sLOAPassword + "]";
	}
	...
	public int hashCode() {
		...
		result = prime * result
				+ ((sASMPassword == null) ? 0 : sASMPassword.hashCode());
		result = prime * result
				+ ((sASMUserName == null) ? 0 : sASMUserName.hashCode());
		...
		result = prime * result
				+ ((sLOAPassword == null) ? 0 : sLOAPassword.hashCode());
		result = prime * result
				+ ((sLOAUserName == null) ? 0 : sLOAUserName.hashCode());
		result = prime * result
				+ ((sMessage == null) ? 0 : sMessage.hashCode());
		result = prime * result + ((sORPath == null) ? 0 : sORPath.hashCode());
		result = prime * result
				+ ((sPAPassword == null) ? 0 : sPAPassword.hashCode());
		result = prime * result
				+ ((sPAUserName == null) ? 0 : sPAUserName.hashCode());
		result = prime * result
	...
	public boolean equals(Object obj) {
		...
		if (mapCustomConfig == null) {
			...
			return false;
		if (sASMPassword == null) {
			if (other.sASMPassword != null)
				return false;
		} else if (!sASMPassword.equals(other.sASMPassword))
			return false;
		if (sASMUserName == null) {
			if (other.sASMUserName != null)
				return false;
		} else if (!sASMUserName.equals(other.sASMUserName))
			return false;
		if (sAppURL == null) {
		...
		if (sFromEmailId == null) {
			...
			return false;
		if (sLOAPassword == null) {
			if (other.sLOAPassword != null)
				return false;
		} else if (!sLOAPassword.equals(other.sLOAPassword))
			return false;
		if (sLOAUserName == null) {
			if (other.sLOAUserName != null)
				return false;
		} else if (!sLOAUserName.equals(other.sLOAUserName))
			return false;
		if (sMessage == null) {
		...
		if (sORPath == null) {
			...
			return false;
		if (sPAPassword == null) {
			if (other.sPAPassword != null)
				return false;
		} else if (!sPAPassword.equals(other.sPAPassword))
			return false;
		if (sPAUserName == null) {
			if (other.sPAUserName != null)
				return false;
		} else if (!sPAUserName.equals(other.sPAUserName))
			return false;
		if (sPassword == null) {
